## EMOWAVE — Construcción completa (Frontend)
...
1. **Inicio** — hero con mensaje _"Entender tus emociones es el primer paso para sentirte mejor."_
...
- **Persistencia**: todo en `localStorage` con claves namespaced (`emowave_*`).
